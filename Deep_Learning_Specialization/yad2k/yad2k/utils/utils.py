...
def draw_boxes(image, boxes, box_classes, class_names, scores=None):
    ...
    #'../FiraMono-Medium.otf'  arial.ttf
    #font_obj = ImageFont.load_path("../FiraMono-Medium.otf")
    ...
    for i, c in list(enumerate(box_classes)):
        ...
        left_, top_, right_, bottom_ = draw.textbbox((0,0), label, font)
        label_size = (right_ - left_, bottom_) 
        assert draw.textbbox((0,0), label, font) == font.getbbox(label)
