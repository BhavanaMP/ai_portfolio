...
Create your own AI agents, build RAG chatbots, and automate tasks with AI.
...
3. Set up your environment variables:
   ...
   poetry env use C:\Users\malla\anaconda3\envs\learning\python.exe
...
Follow the instructions in the "Getting Started" section above. Ensure you have Python 3.10 or 3.11 installed, install Poetry, clone the repository, install dependencies, rename the `.env.example` file to `.env`, and activate the Poetry shell.
